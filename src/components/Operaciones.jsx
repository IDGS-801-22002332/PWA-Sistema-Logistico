        ...
        <form onSubmit={handleFormSubmit} className="form-content">
            <div className="form-grid">
                <div className="form-group">
                    <label className="form-label" htmlFor="referencia_booking">
                        Referencia / Booking*
                    </label>
                    <input
                        id="referencia_booking"
                        name="referencia_booking"
                        value={formData.referencia_booking}
                ...
                <div className="form-group">
                    <label className="form-label" htmlFor="cliente_nombre">
                        Cliente*
                    </label>
                    <input
                        id="cliente_nombre"
                ...
                <div className="form-group">
                    <label
                        ...
                        htmlFor="usuario_operativo_nombre"
                    >
                        Encargado Operativo
                    </label>
                    <input
                ...
                <div className="form-group">
                    <label className="form-label" htmlFor="origen_nombre">
                        Origen
                    </label>
                    <input
                        id="origen_nombre"
                ...
                <div className="form-group">
                    <label className="form-label" htmlFor="destino_nombre">
                        Destino
                    </label>
                    <input
                        id="destino_nombre"
                ...
                <div className="form-group">
                    <label className="form-label" htmlFor="total_venta">
                        Total Venta
                    </label>
                    <input
                        type="number"
                ...
                <div className="form-group">
                    <label
                        className="form-label"
                        htmlFor="fecha_llegada_estimada"
                    >
                        Fecha Llegada Est.
                    </label>
                    <input
                ...
                <div className="form-group">
                    <label className="form-label" htmlFor="estatus_operacion">
                        Estatus
                    </label>
                    <select
                        id="estatus_operacion"
                        name="estatus_operacion"
                        value={formData.estatus_operacion}
                        onChange={handleFormChange}
                        className="form-select"
                    >
                ...
                {formData.descripcion_mercancia && (
                    ...
                    >
                        <label className="form-label">
                            Descripción de Mercancía (desde cotización)
                        </label>
                        <textarea
                            ...
                            placeholder="Información de mercancía transferida desde la cotización"
                        />
                    </div>
                )}
            </div>
...
const OperacionCard = ({ operacion, onAction }) => {
    ...
    return (
        ...
        >
            <div
                style={{ padding: "1.5rem", borderRight: "1px solid #e5e7eb" }}
            >
                <div
                    style={{
                        display: "flex",
                ...
                >
                    ...
                    >
                        ...
                        />
                        Operación <strong>#{operacion.id_operacion}</strong> |
                        Booking: <strong>{operacion.referencia_booking}</strong>
                    </h4>
                    <span
                        style={{
                            fontSize: "0.85rem",
    ...
    useEffect(() => {
        ...
        async function loadData() {
            try {
                ...
                if (mounted) {
                    // Enriquecer operaciones con nombres del objeto relacionado
    ...
    const handleFormSubmit = async (e) => {
        ...
        const payload = {
            ...
            numero_referencia_proveedor:
                formData.referencia_booking || undefined,
        ...
        try {
            ...
            const enrichedOps = (latest || []).map((op) => ({
                ...op,
                cliente_nombre: op.cliente?.nombre_empresa || "N/A",
                usuario_operativo_nombre: op.usuario_operativo?.nombre || "N/A",
            }));
            setOperaciones(enrichedOps);
        } catch (err) {
            console.error(err);
